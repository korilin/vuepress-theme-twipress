            ...
            <div class="container">
                ...
                <div class="text">
                    <article>
                        ...
                        <button>
                            <router-link to="/">I DARE!</router-link>
                        </button>
                    </article>
                </div>
            </div>
        </section>
        <div class="from">This design comes from CodePen</br><a href="https://codepen.io/rafaelavlucas/pen/NWWQNjZ">https://codepen.io/rafaelavlucas/pen/NWWQNjZ</a></div>
    </div>
</template>
